...
var News = function (_React$Component) {
  ...
  function News(props) {
    ...
    window.onhashchange = function (e) {
      return _this.setState({ hash: location.hash });
    };
    return _this;
  }
  ...
  _createClass(News, [{
    ...
    value: function getNews(type) {
      ...
      fetch('http://prometheus.datasektionen.se/api/list/sv/' + type).then(function (response) {
        return response.json();
      }).then(function (json) {
        _this2.setState({ items: json, type: type });
      });
    }
  }, {
    key: 'render',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'ul',
              null,
              React.createElement(TypeButton, { text: 'Alla poster',
                type: 'all',
                stateType: type,
                onClick: function onClick(e) {
                  return _this3.getNews('all');
                } }),
              React.createElement(TypeButton, { text: 'Bara event',
                type: 'event',
                stateType: type,
                onClick: function onClick(e) {
                  return _this3.getNews('event');
                } }),
              React.createElement(TypeButton, { text: 'Inte event',
                type: 'post',
                stateType: type,
                onClick: function onClick(e) {
                  return _this3.getNews('post');
                } })
            )
          )
        ),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                null,
                this.state.hash.length > 1 ? React.createElement(SingleItem, { id: this.state.hash.substring(1) }) : items.map(function (item) {
                  return React.createElement(NewsItem, _extends({ key: item.id }, item));
                })
              )
            )
          )
...
var SingleItem = function (_React$Component2) {
  ...
  function SingleItem(props) {
    ...
    var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(SingleItem).call(this, props));
  ...
  _createClass(SingleItem, [{
    ...
    value: function getContent(id) {
      ...
      fetch('http://prometheus.datasektionen.se/api/item/' + id).then(function (response) {
        return response.json();
      }).then(function (json) {
        return _this5.setState(json);
      });
    }
  }, {
    key: 'componentDidMount',
    ...
    value: function render() {
      ...
      var title_sv = _state2.title_sv;
      var content_sv = _state2.content_sv;
      ...
      return React.createElement(
        ...
        React.createElement('p', { dangerouslySetInnerHTML: { __html: content_sv } }),
        React.createElement(
          'p',
          null,
          author
...
function TypeButton(props) {
  return React.createElement(
    ...
    React.createElement(
      'a',
      { className: props.type === props.stateType ? "text-theme-color strong" : false,
...
function NewsItem(props) {
  return React.createElement(
    ...
    React.createElement(
      'a',
      { href: '#' + props.id, className: 'notice ultra_light', style: { display: "block" } },
      React.createElement(
        'h3',
        null,
        props.title_sv
      ),
      React.createElement('p', { dangerouslySetInnerHTML: { __html: props.content_sv } })
    )
  );
}

ReactDom.render(React.createElement(News, null), document.querySelector('#mount_point'));

},{"react":167,"react-dom":29,"whatwg-fetch":168}]},{},[169]);
